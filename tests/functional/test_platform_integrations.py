...
from backend.App.orchestration.application.agents.review_moa import moa_enabled_for_step
...
def test_resolve_preset_spec_only_is_alias_for_planning_loop():
    assert resolve_preset("spec_only") == resolve_preset("planning_loop")
