...
def test_cancel_event_set_after_generator_exhausted():
    ...
    from backend.UI.REST.presentation.stream_handlers import _sync_sse_generator_to_async
...
def test_pipeline_should_cancel_responds_to_event():
    ...
    from backend.App.orchestration.application.pipeline_graph import _pipeline_should_cancel
