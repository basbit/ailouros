...
from backend.App.integrations.infrastructure.mcp.openai_loop._dispatch import (
    mcp_write_action_from_tool_call as _mcp_write_action_from_tool_call,
    parse_text_tool_calls as _parse_text_tool_calls,
    normalize_text_tool_names as _normalize_text_tool_names,
)
...
def testmcp_write_action_from_tool_call_write_file_create(tmp_path):
...
def testmcp_write_action_from_tool_call_write_file_overwrite(tmp_path):
...
def testmcp_write_action_from_tool_call_edit_file_existing(tmp_path):
    path = tmp_path / "existing.py"
    path.write_text("x=1\n", encoding="utf-8")
