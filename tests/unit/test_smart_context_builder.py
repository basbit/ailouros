...
def test_build_context_with_mock_embeddings(monkeypatch):
    ...
    monkeypatch.setattr(
        "backend.App.orchestration.application.context.smart_context_builder._get_provider",
        lambda: fake,
    )
    ...
    import backend.App.orchestration.application.context.smart_context_builder as scb
