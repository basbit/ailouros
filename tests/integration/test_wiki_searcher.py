...
from backend.App.shared.infrastructure.wiki_frontmatter import strip_frontmatter as _strip_frontmatter
...
def test_load_wiki_context_uses_searcher_when_query_provided(tmp_path, monkeypatch):
    ...
    _install_provider(monkeypatch, _StubProvider())
    from backend.App.workspace.application.wiki import wiki_context_loader
