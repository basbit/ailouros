...
def test_generate_documentation_uses_architect_prompt_only_from_code_diagram(monkeypatch):
    ...
    monkeypatch.setattr("backend.App.orchestration.application.routing.pipeline_graph.CodeDiagramAgent", FakeDiagram)
    monkeypatch.setattr("backend.App.orchestration.application.routing.pipeline_graph.DocGenerateAgent", FakeDoc)
    monkeypatch.setattr("backend.App.orchestration.application.routing.pipeline_graph._remote_api_client_kwargs", lambda _s: {})
