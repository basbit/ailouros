...
from backend.App.orchestration.application.enforcement.self_verify import SelfVerifier, VerifyResult, run_with_self_verify
...
def test_verify_disabled_by_default(monkeypatch):
    ...
    import backend.App.orchestration.application.enforcement.self_verify as sv
