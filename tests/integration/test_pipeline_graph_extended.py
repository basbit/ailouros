...
def test_validate_pipeline_steps_empty_raises():
    from backend.App.orchestration.application.routing.pipeline_graph import validate_pipeline_steps
...
def test_resolve_pipeline_step_known():
    from backend.App.orchestration.application.routing.pipeline_graph import _resolve_pipeline_step
...
def test_wrap_human_gate_auto_approved():
    ...
    with patch(
        "backend.App.orchestration.application.routing.graph_builder._approval_policy",
        mock_policy,
    ):
