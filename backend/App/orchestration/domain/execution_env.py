"""Execution environment domain model — R1.2 Managed execution environments.
...
class SandboxProfile(str, Enum):
    """Predefined sandbox profiles with different permission sets."""
...
class EnvironmentManifest:
    """Declared environment contract for a pipeline step."""
