"""Marketing pipeline nodes: seo_specialist, ai_citation_strategist, app_store_optimizer + reviews + human gates."""
...
def seo_specialist_node(state: PipelineState) -> dict[str, Any]:
    """SEO: technical audit, keyword strategy, content optimization."""
...
def ai_citation_strategist_node(state: PipelineState) -> dict[str, Any]:
    """AEO/GEO: AI citation audit, competitor analysis, fix packs."""
    agent_config = state.get("agent_config") or {}
...
def app_store_optimizer_node(state: PipelineState) -> dict[str, Any]:
    """ASO: keyword optimization, visual assets, conversion rate optimization."""
    agent_config = state.get("agent_config") or {}
