"""Pure configuration-reader helpers for pipeline nodes.

Extracted from ``nodes/_shared.py`` — no filesystem operations, no FastAPI imports.
"""
...
def reviewer_cfg(state: PipelineState) -> dict[str, Any]:
    """Return agent_config.reviewer sub-dict (or empty dict)."""
...
def skills_extra(
    ...
    """Return formatted skills extra string for the given role config."""
