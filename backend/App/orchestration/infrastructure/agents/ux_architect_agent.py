"""UX Architect agent — technical architecture and UX foundations."""
...
class UXArchitectAgent(BaseAgent):
    def __init__(
        ...
        *,
        ...
        fallback = (
            "You are a UX Architect. Create CSS design systems, layout frameworks, "
            "and UX structure that gives developers solid foundations for implementation."
        )
        prompt_path = system_prompt_path_override or "design/design-ux-architect.md"
        super().__init__(
            role="UX_ARCHITECT",
            system_prompt=load_prompt(prompt_path, fallback),
            model=model_override or resolve_agent_model("UX_ARCHITECT"),
